...
// Execute Copy Function
 async function res() {
  ...
  // await client.query('CREATE TABLE answers (answer_id int primary key, question_id int references questions (question_id), body text, date bigint, answerer_name varchar(200), answerer_email varchar(200), reported int, helpful int)');
  // await client.query(`COPY answers (answer_id, question_id, body,date, answerer_name, answerer_email, reported, helpful)FROM '${answersFile}' DELIMITER ','
  // CSV HEADER`);
