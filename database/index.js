...
var questionsFile = '/Users/oscarcarvente/Desktop/questions.csv';/// path.join(__dirname, './data/questions.csv');
...
// Execute Copy Function
 async function res() {
  ...
  // await client.query(`COPY public.questions (id,product_id,body,date_written,asker_name, asker_email, reported, helpful)FROM '${questionsFile}' DELIMITER ','
  // CSV HEADER`);
...
console.log(res);
res().then(res => console.log('resolved, ', res)).catch(err => console.log('did not resolve, ', err));
